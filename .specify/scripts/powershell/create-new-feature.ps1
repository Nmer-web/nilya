...
# Project decision: every Spec Kit artifact lives under .specify/, so feature
# directories are created at .specify/specs/ rather than at the repository root.
# Get-FeaturePathsEnv resolves from .specify/feature.json and is path-agnostic,
# so nothing downstream needs to know where this points.
