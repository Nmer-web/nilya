...
- [ ] TXXX Run `npm run typecheck` — MUST report zero errors
- [ ] TXXX Run `npm run lint` — MUST report zero errors
- [ ] TXXX Runtime-verify each user story against a real account, and record what was executed,
      what was observed, and what remains unverified with the reason why
