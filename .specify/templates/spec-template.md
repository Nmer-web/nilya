...
- What does the user see when the underlying data is genuinely empty? (Constitution Principle II —
  emptiness is a shippable state and MUST be specified, never filled with sample content.)
...
<!--
  Constitution Principle II: acceptance scenarios MUST NOT assume data that does not exist.
